...
current_analysis = nr_analysis_xe1t.nr_analysis_xe1t('cnns', 'lax_0.11.1', num_mc_events, num_walkers, num_steps_to_include, b_mc_paper_mode=False, b_conservative_acceptance_posterior=False)
...
#print d_sampler_values['acceptance_par']
#print '\n\n\nTESTING WITH DIFFERENT ACCEPTANCE\n\n\n'
#d_sampler_values['acceptance_par'] = np.asarray(4.5, dtype=np.float32)

#print '\n\n\nTESTING WITH DIFFERENT W\n\n\n'
#d_sampler_values['w_value'] *= 0.8
...
d_mc = {'d_mc':df_mc.to_dict('series'), 'scale_factor':current_analysis.get_scale_factor()}
