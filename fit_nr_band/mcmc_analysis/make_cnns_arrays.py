...
current_analysis = nr_analysis_xe1t.nr_analysis_xe1t('cnns', 'lax_0.11.1', num_mc_events, num_walkers, num_steps_to_include, b_mc_paper_mode=False, b_conservative_acceptance_posterior=True)
