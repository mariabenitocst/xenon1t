...
fig_s1.savefig('%ss1_bias_and_smearing.png' % (s_path_to_plots))
fig_s2.savefig('%ss2_bias_and_smearing.png' % (s_path_to_plots))

pickle.dump(d_smearing, open('%ss1_s2_bias_and_smearing.p' % (s_path_to_pickle_save), 'w'))
