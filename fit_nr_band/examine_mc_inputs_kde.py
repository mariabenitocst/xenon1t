...
d_mc_maps_full = d_mc_maps_full[(d_mc_maps_full['Ed'] < 100)]

d_mc_maps = {}
d_mc_maps['energy'] = np.asarray(d_mc_maps_full['Ed'], dtype=np.float32)
d_mc_maps['x'] = np.asarray(d_mc_maps_full['X']/10., dtype=np.float32)
d_mc_maps['y'] = np.asarray(d_mc_maps_full['Y']/10., dtype=np.float32)
d_mc_maps['z'] = np.asarray(d_mc_maps_full['Z']/10., dtype=np.float32)
...
# make in fit_nr_band.py with cuts
