	...
	if (iteration < *num_trials)
	{
        ...
        for (repetition_number=0; repetition_number < *num_loops; repetition_number++)
        {
            ...
            else
            {
                ...
                // find indices of s1 and s2 bins for 2d histogram
                if (curand_uniform(&s) > *prob_ac_bkg)
                {
                ...
                {
                    s1_bin = gpu_find_lower_bound(num_bins_s1, bin_edges_s1, a_ac_bkg_s1[iteration]);
                    log_s2_s1_bin = gpu_find_lower_bound(num_bins_log_s2_s1, bin_edges_log_s2_s1, a_ac_bkg_log[iteration]);
                }
                
                
                mc_s2_tot = powf(10., a_ac_bkg_log[iteration])*a_ac_bkg_s1[iteration] / area_bottom_fraction;
	...
	if (iteration < *num_trials)
	{
        ...
        for (repetition_number=0; repetition_number < 1; repetition_number++)
        {
            ...
            else
            {
                ...
                {
                    a_s1[iteration] = a_ac_bkg_log[iteration];
                    a_s2[iteration] = powf(10., a_ac_bkg_log[iteration])*a_s1[iteration];
                }
